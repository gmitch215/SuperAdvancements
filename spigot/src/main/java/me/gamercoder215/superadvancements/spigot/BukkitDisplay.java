...
public final class BukkitDisplay extends ADisplay {
    ...
    /**
     * Creates a new Builder for a Bukkit Advancement Display.
     * @param frame Frame Type
     * @return New Builder
    ...
    public static final class Builder {
         ...
         */
        @NotNull
        public BukkitDisplay build() throws IllegalArgumentException {
            if (title == null) throw new IllegalArgumentException("Title cannot be null!");
            if (frame == null) throw new IllegalArgumentException("Frame cannot be null!");
            if (icon == null) throw new IllegalArgumentException("Icon cannot be null!");

            BukkitDisplay display = new BukkitDisplay(frame);
