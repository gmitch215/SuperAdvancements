...
import net.minecraft.advancements.critereon.CriterionConditionEntity.b;
...
final class Wrapper1_17_R1 implements Wrapper {
    ...
    public static CriterionConditionValue.IntegerRange toIntRange(Range r) {
        ...
        return CriterionConditionValue.IntegerRange.a((int) r.getMinimum(), (int) r.getMaximum());
    }

    public static CriterionConditionValue.DoubleRange toDoubleRange(Range r) {
        if (r == null) return CriterionConditionValue.DoubleRange.e;
        return CriterionConditionValue.DoubleRange.a(r.getMinimum(), r.getMaximum());
    }

    public static Range fromNMS(CriterionConditionValue.DoubleRange r) {
    ...
    public static CriterionTriggerProperties toNMSP(BlockState state) {
        ...
        try {
            Class<?> clazz = Class.forName("net.minecraft.advancements.criterion.CriterionTriggerProperties$a");
    ...
    public static <T> RegistryMaterials<T> getRegistry(ResourceKey<IRegistry<T>> key) {
        ...
        return (RegistryMaterials<T>) server.getCustomRegistry().d(key);
    }
    ...
    public static CriterionConditionLight.a toNMS(ATriggerPredicate.Light predicate) {
        if (predicate == null) return new CriterionConditionLight.a();
        return new CriterionConditionLight.a()
                .a(toIntRange(predicate.getBrightnessRange()));
    }
    ...
    public static CriterionConditionBlock.a toNMS(ATriggerPredicate.Block predicate) {
        try {
            ...
            return builder
                    .a(predicate.getMaterials().stream()
                            .map(Wrapper1_17_R1::toNMS)
                            .toArray(Block[]::new)
                    );
        } catch (ReflectiveOperationException e) {
            throw new RuntimeException(e);
    ...
    public static CriterionConditionLocation.a toNMS(ATriggerPredicate.Location predicate) {
        try {
            ...
            if (predicate == null) return builder;
            builder.a(toDoubleRange(predicate.getXRange()))
                    .b(toDoubleRange(predicate.getYRange()))
                    .c(toDoubleRange(predicate.getZRange()))
                    .a(predicate.isSmokey());

            if (predicate.getBiome() != null) builder.a(getKey(predicate.getBiome(), IRegistry.aO));
            if (predicate.getBlockPredicate() != null) builder.a(toNMS(predicate.getBlockPredicate()).b());
            if (predicate.getLightPredicate() != null) builder.a(toNMS(predicate.getLightPredicate()).b());
            if (predicate.getDimension() != null) {
                ...
                builder.b(getKey(key, IRegistry.Q));
            }
    ...
    public static CriterionConditionItem.a toNMS(ATriggerPredicate.Item predicate) {
        try {
            ...
            builder.a(predicate.getIncludes().stream()
                            .map(CraftItemStack::asNMSCopy)
                            .map(net.minecraft.world.item.ItemStack::getItem)
                            .toArray(Item[]::new))
                    .a(toIntRange(predicate.getCountRange()))
                    .b(toIntRange(predicate.getDurabilityRange()));

            predicate.getEnchantments().stream().map(Wrapper1_17_R1::toNMS).forEach(builder::a);
            predicate.getStoredEnchantments().stream().map(Wrapper1_17_R1::toNMS).forEach(builder::b);
    ...
    public static CriterionConditionEntity.a toNMS(ATriggerPredicate.Entity predicate) {
        try {
            ...
            if (predicate.getPlayerDistanceRange() != null)
                builder.a(CriterionConditionDistance.a(toDoubleRange(predicate.getPlayerDistanceRange())));
            if (!predicate.getEquipment().isEmpty()) {
                ...
                for (Map.Entry<EquipmentSlot, ATriggerPredicate.Item> entry : predicate.getEquipment().entrySet()) {
                    switch (entry.getKey()) {
                        case HEAD -> equipment.a(toNMS(entry.getValue()).b());
                        case CHEST -> equipment.b(toNMS(entry.getValue()).b());
                        case LEGS -> equipment.c(toNMS(entry.getValue()).b());
                        case FEET -> equipment.d(toNMS(entry.getValue()).b());
                        case HAND -> equipment.e(toNMS(entry.getValue()).b());
                        case OFF_HAND -> equipment.f(toNMS(entry.getValue()).b());
                    }
                }
            ...
            builder.a(flags
                    .b(predicate.isCrouching())
                    .a(predicate.isOnFire())
                    .c(predicate.isSprinting())
                    .d(predicate.isSwimming())
                    .e(predicate.isBaby())
                    .b()
            );

            if (predicate.getTarget() != null) builder.c(toNMS(predicate.getTarget()).b());
            if (predicate.getPassenger() != null) builder.b(toNMS(predicate.getPassenger()).b());
    ...
    public static CriterionConditionDamage toNMS(ATriggerPredicate.Damage predicate) {
        try {
            ...
            builder.a(toDoubleRange(predicate.getDealtRange()));
            builder.b(toDoubleRange(predicate.getTakenRange()));
            builder.a(predicate.wasBlocked());

            if (predicate.getSourcePredicate() != null) builder.a(toNMSP(predicate.getSourcePredicate()));
    ...
    public static CriterionConditionDistance toNMSP(Range range) {
        ...
        return CriterionConditionDistance.a(toDoubleRange(range));
    }
    ...
    public static CriterionInstance toNMS(ATrigger trigger) {
        ...
        return switch (trigger.getKey().getKey()) {
            ...
            case "bee_nest_destroyed" -> {
                ...
                yield CriterionTriggerBeeNestDestroyed.a.a(toNMS(block), toNMS(item), toIntRange(beesInside));
            }
            case "bred_animals" -> {
                ...
                yield CriterionTriggerBredAnimals.a.a(toNMSP(parent1), toNMSP(parent2), toNMSP(child));
            }
            case "brewed_potion" -> {
                PotionType potion = (PotionType) c.get("potion");
                yield new CriterionTriggerBrewedPotion.a(b.a, toNMS(potion));
            }
            case "changed_dimension" -> {
                ...
                yield CriterionTriggerChangedDimension.a.a(getKey(from, IRegistry.Q), getKey(to, IRegistry.Q));
            }
            case "channeled_lightning" -> {
                ATriggerPredicate.Entity[] victims = (ATriggerPredicate.Entity[]) c.get("victims");
                if (victims == null) yield CriterionTriggerChanneledLightning.a.a(new CriterionConditionEntity[0]);

                yield CriterionTriggerChanneledLightning.a.a(
                        Arrays.stream(victims)
                                .map(Wrapper1_17_R1::toNMSP)
                                .toArray(CriterionConditionEntity[]::new)
                );
            }
            case "construct_beacon" -> {
                Range level = (Range) c.get("level");
                yield CriterionTriggerConstructBeacon.a.a(toIntRange(level));
            }
            case "consume_item" -> {
                ATriggerPredicate.Item item = (ATriggerPredicate.Item) c.get("item");
                yield CriterionTriggerConsumeItem.a.a(toNMSP(item));
            }
            case "cured_zombie_villager" -> {
                ...
                yield new CriterionTriggerCuredZombieVillager.a(b.a, b.a(toNMSP(zombie)), b.a(toNMSP(villager)));
            }
            case "enchanted_item" -> {
                ATriggerPredicate.Item item = (ATriggerPredicate.Item) c.get("item");
                Range levels = (Range) c.get("levels");
                yield new CriterionTriggerEnchantedItem.a(b.a, toNMSP(item), toIntRange(levels));
            }
            case "enter_block" -> {
                Material block = (Material) c.get("block");
                BlockState state = (BlockState) c.get("state");
                yield new CriterionTriggerEnterBlock.a(b.a, toNMS(block), toNMSP(state));
            }
            case "entity_hurt_player" -> {
                ATriggerPredicate.Damage damage = (ATriggerPredicate.Damage) c.get("damage");
                yield CriterionTriggerEntityHurtPlayer.a.a(toNMS(damage));
            }
            case "entity_killed_player", "player_killed_entity" -> {
                ATriggerPredicate.Entity entity = (ATriggerPredicate.Entity) c.get("entity");
                yield new CriterionTriggerKilled.a(new MinecraftKey(trigger.getKey().getKey()), b.a, b.a(toNMSP(entity)), CriterionConditionDamageSource.a);
            }
            case "fishing_rod_hooked" -> {
                ATriggerPredicate.Item rod = (ATriggerPredicate.Item) c.get("rod");
                ATriggerPredicate.Entity entity = (ATriggerPredicate.Entity) c.get("entity");
                ATriggerPredicate.Item item = (ATriggerPredicate.Item) c.get("item");
                yield CriterionTriggerFishingRodHooked.a.a(toNMSP(rod), toNMSP(entity), toNMSP(item));
            }
            ...
            case "inventory_changed" -> {
                ...
                yield new CriterionTriggerInventoryChanged.a(b.a, toIntRange(emptySlots), toIntRange(fullSlots), toIntRange(occupiedSlots), predicates);
            }
            case "item_durability_changed" -> {
                ATriggerPredicate.Item item = (ATriggerPredicate.Item) c.get("item");
                Range delta = (Range) c.get("delta");
                Range durability = (Range) c.get("durability");
                yield new CriterionTriggerItemDurabilityChanged.a(b.a, toNMSP(item), toIntRange(delta), toIntRange(durability));
            }
            case "item_used_on_block" -> {
                ATriggerPredicate.Location location = (ATriggerPredicate.Location) c.get("location");
                ATriggerPredicate.Item item = (ATriggerPredicate.Item) c.get("item");
                yield CriterionTriggerInteractBlock.a.a(toNMS(location), toNMS(item));
            }
            case "killed_by_crossbow" -> {
                ...
                yield new CriterionTriggerKilledByCrossbow.a(b.a, predicates, toIntRange(uniqueTypes));
            }
            case "levitation" -> {
                Range distance = (Range) c.get("distance");
                Range duration = (Range) c.get("duration");
                yield new CriterionTriggerLevitation.a(b.a, toNMSP(distance), toIntRange(duration));
            }
            case "lightning_strike" -> {
                ...
                yield LightningStrikeTrigger.a.a(toNMSP(lightning), toNMSP(bystander));
            }
            ...
            case "nether_travel" -> {
                ...
                Range distance = (Range) c.get("distance");
                yield new CriterionTriggerNetherTravel.a(b.a, toNMSP(startPosition), CriterionConditionLocation.a, toNMSP(distance));
            }
            case "placed_block" -> {
                Material block = (Material) c.get("block");
                ATriggerPredicate.Item item = (ATriggerPredicate.Item) c.get("item");
                ...
                yield new CriterionTriggerPlacedBlock.a(b.a, toNMS(block), toNMSP(state), toNMSP(location), toNMSP(item));
            }
            case "player_generates_container_loot" -> {
                NamespacedKey lootTable = (NamespacedKey) c.get("loot_table");
                yield CriterionTriggerPlayerGeneratesContainerLoot.a.a(toNMS(lootTable));
            }
            case "player_hurt_entity" -> {
                ATriggerPredicate.Damage damage = (ATriggerPredicate.Damage) c.get("damage");
                ATriggerPredicate.Entity entity = (ATriggerPredicate.Entity) c.get("entity");
                yield CriterionTriggerPlayerHurtEntity.a.a(toNMS(damage), toNMSP(entity));
            }
            case "player_interacted_with_entity" -> {
                ATriggerPredicate.Entity entity = (ATriggerPredicate.Entity) c.get("entity");
                ATriggerPredicate.Item item = (ATriggerPredicate.Item) c.get("item");
                yield CriterionTriggerPlayerInteractedWithEntity.a.a(b.a, toNMS(item), b.a(toNMSP(entity)));
            }
            case "recipe_unlocked" -> {
                NamespacedKey recipe = (NamespacedKey) c.get("recipe");
                yield new CriterionTriggerRecipeUnlocked.a(b.a, toNMS(recipe));
            }
            case "shot_crossbow" -> {
                ATriggerPredicate.Item item = (ATriggerPredicate.Item) c.get("item");
                yield CriterionTriggerShotCrossbow.a.a(toNMSP(item));
            }
            case "slept_in_bed" -> CriterionTriggerLocation.a.c();
            case "slide_down_block" -> {
                Material block = (Material) c.get("block");
                BlockState state = (BlockState) c.get("state");
                yield new CriterionSlideDownBlock.a(b.a, toNMS(block), toNMSP(state));
            }
            case "started_riding" -> new StartRidingTrigger.a(b.a);
            case "tame_animal" -> {
                ATriggerPredicate.Entity entity = (ATriggerPredicate.Entity) c.get("entity");
                yield CriterionTriggerTamedAnimal.a.a(toNMSP(entity));
            }
            case "target_hit" -> {
                ...
                yield CriterionTriggerTargetHit.a.a(toIntRange(signalStrength), b.a(toNMSP(projectile)));
            }
            case "tick" -> new CriterionTriggerTick.a(b.a);
            case "used_ender_eye" -> {
                Range distance = (Range) c.get("distance");
                yield new CriterionTriggerUsedEnderEye.a(b.a, toDoubleRange(distance));
            }
            case "used_totem" -> {
                ATriggerPredicate.Item item = (ATriggerPredicate.Item) c.get("item");
                yield CriterionTriggerUsedTotem.a.a(toNMSP(item));
            }
            case "using_item" -> {
                ATriggerPredicate.Item item = (ATriggerPredicate.Item) c.get("item");
                yield new UsingItemTrigger.a(b.a, toNMSP(item));
            }
            case "villager_trade" -> {
                ATriggerPredicate.Item item = (ATriggerPredicate.Item) c.get("item");
                ATriggerPredicate.Entity villager = (ATriggerPredicate.Entity) c.get("villager");
                yield new CriterionTriggerVillagerTrade.a(b.a, b.a(toNMSP(villager)), toNMSP(item));
            }
            case "voluntary_exile" -> new CriterionTriggerLocation.a(new MinecraftKey("voluntary_exile"), b.a, CriterionConditionLocation.a);
    ...
    public static ATrigger fromNMS(CriterionInstance t) {
        ...
        return switch (t.a().getKey()) {
            ...
            case "used_ender_eye" -> ATrigger.usedEnderEye(
                fromNMS(getObject(t, "a", CriterionConditionValue.DoubleRange.class))
            );
    ...
    public static net.minecraft.advancements.Advancement toNMS(Advancement a) {
        ...
        if (manager.c.a(toNMS(a.getKey())) != null) return manager.c.a(toNMS(a.getKey()));

        ADisplay display = a.getDisplay();
        String title = display.getTitleAsString();
        String desc = display.getDescriptionAsString();
        AdvancementFrameType frame = Arrays.stream(AdvancementFrameType.values()).filter(f -> f.a().equalsIgnoreCase(display.getFrame().name())).findFirst().orElse(AdvancementFrameType.a);
        ...
        return new net.minecraft.advancements.Advancement(
                ...
                a.hasFlag(AFlag.MERGE_CRITERIA) ? AdvancementRequirements.b.createRequirements(a.getCriteria().keySet()) : AdvancementRequirements.a.createRequirements(a.getCriteria().keySet())
        );
    }
    ...
    public static Biome fromNMS(ResourceKey<BiomeBase> biome) {
        ...
        RegistryMaterials<BiomeBase> registry = getRegistry(IRegistry.aO);
        return CraftBlock.biomeBaseToBiome(registry, registry.get(biome.a()));
    }

    public static World fromNMSW(ResourceKey<net.minecraft.world.level.World> world) {
        if (world == null) return null;
        RegistryMaterials<net.minecraft.world.level.World> registry = getRegistry(IRegistry.Q);
        return registry.d(world).getWorld();
    }
    ...
    public static EntityType fromNMS(CriterionConditionEntityType p) {
        ...
        try {
            ...
            if (EntityTypes.class.isAssignableFrom(typeC)) {
                ...
                return EntityType.valueOf(IRegistry.Y.getKey(entityType).getKey().toUpperCase());
            } else {
    ...
    public static Range fromNMS(CriterionConditionDistance p) {
        if (p == null) return null;
        return fromNMS(getObject(p, "f", CriterionConditionValue.DoubleRange.class));
    }
    ...
    public static Enchantment fromNMS(net.minecraft.world.item.enchantment.Enchantment enchant) {
        ...
        NamespacedKey key = fromNMS(IRegistry.X.getKey(enchant));
        return CraftEnchantment.getByKey(key);
    }

    public static PotionType fromNMS(PotionRegistry potion) {
        if (potion == null) return null;
        MinecraftKey loc = IRegistry.aa.getKey(potion);
    ...
    public static BlockState fromNMS(Block block, CriterionTriggerProperties predicate) {
        ...
        try {
            ...
            return CraftBlockStates.getBlockState(BlockPosition.b, nms, null);
        } catch (ReflectiveOperationException e) {
            throw new RuntimeException(e);
        }
    }
    ...
    public static ATriggerPredicate.Damage fromNMS(CriterionConditionDamage p) {
        ...
        return ATriggerPredicate.Damage.builder()
                .dealt(fromNMS(getObject(p, "b", CriterionConditionValue.DoubleRange.class)))
                .taken(fromNMS(getObject(p, "c", CriterionConditionValue.DoubleRange.class)))
    ...
    public static ATriggerPredicate.Enchantment fromNMS(CriterionConditionEnchantments p) {
        ...
        return ATriggerPredicate.Enchantment.builder()
                .enchantment(fromNMS(getObject(p, "c", net.minecraft.world.item.enchantment.Enchantment.class)))
    ...
    public static ATriggerPredicate.Location fromNMS(CriterionConditionLocation p) {
        ...
        return ATriggerPredicate.Location.builder()
                .x(fromNMS(getObject(p, "c", CriterionConditionValue.DoubleRange.class)))
                .y(fromNMS(getObject(p, "d", CriterionConditionValue.DoubleRange.class)))
                .z(fromNMS(getObject(p, "e", CriterionConditionValue.DoubleRange.class)))
    ...
    public static AReward fromNMS(AdvancementRewards rewards) {
        ...
        try {
            ...
            return new AReward(
                    experience,
                    Arrays.stream(loot).map(Wrapper1_17_R1::fromNMS).collect(Collectors.toList()),
                    Arrays.stream(rewards.a()).map(Wrapper1_17_R1::fromNMS).collect(Collectors.toList())
            );
        } catch (ReflectiveOperationException e) {
            throw new RuntimeException(e);
        }
    ...
    public static Advancement fromNMS(net.minecraft.advancements.Advancement a) {
        if (a == null) return null;
        NMSDisplay1_17_R1 display = new NMSDisplay1_17_R1(a.c());
        ...
        if (a.c().h()) builder.flags(AFlag.TOAST);
    ...
    public void register(Advancement a) {
        ...
        if (manager.c.b.containsKey(nms.getName())) throw new IllegalStateException("Advancement is already registered");
        manager.c.a(Map.of(key, nms.a()));
    }

    @Override
    public Advancement getAdvancement(NamespacedKey key) {
        net.minecraft.advancements.Advancement nms = manager.c.a(toNMS(key));
    ...
    public boolean isRegistered(NamespacedKey key) {
        return manager.c.b.containsKey(toNMS(key));
    }

    @Override
    public void unregister(NamespacedKey key) {
        manager.c.a(Set.of(toNMS(key)));
    ...
    public void addAdvancement(Player p, Set<Advancement> advancements) {
        ...
        for (Advancement a : advancements) {
            ...
            try {
                Method regListeners = AdvancementDataPlayer.class.getDeclaredMethod("c", net.minecraft.advancements.Advancement.class);
        ...
        sp.b.sendPacket(new PacketPlayOutAdvancements(false, added, Set.of(), map));
        sp.getAdvancementData().b(sp);
    ...
    public void removeAdvancement(Player p, Set<NamespacedKey> key) {
        EntityPlayer sp = toNMS(p);
        Set<MinecraftKey> removed = key.stream().map(Wrapper1_17_R1::toNMS).collect(Collectors.toSet());
        sp.b.sendPacket(new PacketPlayOutAdvancements(false, Set.of(), removed, Map.of()));
    }
    ...
    public AProgress getProgress(Player p, NamespacedKey key) {
        ...
        return new AProgress1_17_R1(p, nms, sp.getAdvancementData().getProgress(nms));
    }
    ...
    public Advancement getSelectedTab(Player p) {
        ...
        net.minecraft.advancements.Advancement lastSelectedTab = getObject(sp.getAdvancementData(), "l", net.minecraft.advancements.Advancement.class);
