package me.gamercoder215.superadvancements.v1_15_R1;
...
final class Wrapper1_15_R1 implements Wrapper {
    ...
    public static net.minecraft.server.v1_15_R1.ItemStack toNMS(ItemStack item) {
    ...
    public static net.minecraft.server.v1_15_R1.Enchantment toNMS(Enchantment enchantment) {
    ...
    public static Map<IBlockState, Comparable<?>> toNMS(BlockState state) {
        if (state == null) return Map.of();

        IBlockData nms = ((CraftBlockState) state).getHandle();
        Map<IBlockState, Comparable<?>> map = new HashMap<>();
    ...
    public static CriterionTriggerProperties toNMSP(BlockState state) {
        ...
        Map<IBlockState, Comparable<?>> map = toNMS(state);

        CriterionTriggerProperties.a builder;
        try {
            Class<?> clazz = Class.forName("net.minecraft.server.v1_15_R1.CriterionTriggerProperties$a");
        ...
        map.forEach((k, v) -> builder.a(k, (Comparable & INamable) v));
        return builder.b();
    }
    ...
    public static CriterionConditionBlock.a toNMS(ATriggerPredicate.Block predicate) {
        try {
            ...
            if (!predicate.getMaterials().isEmpty()) setObject(builder, "a", toNMS(predicate.getMaterials().stream().findFirst().orElseThrow()));
    ...
    public static CriterionConditionLocation.a toNMS(ATriggerPredicate.Location predicate) {
        try {
            ...
            if (predicate.getBlockPredicate() != null) setObject(builder, "h", toNMS(predicate.getBlockPredicate()).b());

            if (predicate.getBiome() != null) setObject(builder, "d", IRegistry.BIOME.get(toNMS(predicate.getBiome().getKey())));
            if (predicate.getLightPredicate() != null) setObject(builder, "g", toNMS(predicate.getLightPredicate()));
    ...
    public static CriterionConditionItem.a toNMS(ATriggerPredicate.Item predicate) {
        try {
            ...
            predicate.getEnchantments().stream().map(Wrapper1_15_R1::toNMS).forEach(builder::a);
    ...
    public static CriterionInstance toNMS(ATrigger trigger) {
        ...
        switch (trigger.getKey().getKey()) {
            ...
            case "bred_animals": {
                ...
                return new CriterionTriggerBredAnimals.a(toNMSP(parent1), toNMSP(parent2), toNMSP(child));
            }
            case "brewed_potion": {
                PotionType potion = (PotionType) c.get("potion");
                return new CriterionTriggerBrewedPotion.a(toNMS(potion));
            }
            case "changed_dimension": {
                ...
                return new CriterionTriggerChangedDimension.a(from, to);
            }
            ...
            case "consume_item": {
                ATriggerPredicate.Item item = (ATriggerPredicate.Item) c.get("item");
                return new CriterionTriggerConsumeItem.a(toNMSP(item));
            }
            case "cured_zombie_villager": {
                ...
                return new CriterionTriggerCuredZombieVillager.a(toNMSP(zombie), toNMSP(villager));
            }
            case "enchanted_item": {
                ATriggerPredicate.Item item = (ATriggerPredicate.Item) c.get("item");
                Range levels = (Range) c.get("levels");
                return new CriterionTriggerEnchantedItem.a(toNMSP(item), toIntRange(levels));
            }
            case "enter_block": {
                Material block = (Material) c.get("block");
                BlockState state = (BlockState) c.get("state");
                return new CriterionTriggerEnterBlock.a(toNMS(block), toNMSP(state));
            }
            case "entity_hurt_player": {
                ATriggerPredicate.Damage damage = (ATriggerPredicate.Damage) c.get("damage");
                return new CriterionTriggerEntityHurtPlayer.a(toNMS(damage));
            }
            case "entity_killed_player":
            case "player_killed_entity": {
                ATriggerPredicate.Entity entity = (ATriggerPredicate.Entity) c.get("entity");
                return new CriterionTriggerKilled.a(new MinecraftKey(trigger.getKey().getKey()), toNMSP(entity), CriterionConditionDamageSource.a);
            }
            ...
            case "inventory_changed": {
                ...
                return new CriterionTriggerInventoryChanged.a(toIntRange(emptySlots), toIntRange(fullSlots), toIntRange(occupiedSlots), predicates);
            }
            case "item_durability_changed": {
                ATriggerPredicate.Item item = (ATriggerPredicate.Item) c.get("item");
                Range delta = (Range) c.get("delta");
                Range durability = (Range) c.get("durability");
                return new CriterionTriggerItemDurabilityChanged.a(toNMSP(item), toIntRange(delta), toIntRange(durability));
            }
            case "item_used_on_block": {
                ATriggerPredicate.Location location = (ATriggerPredicate.Location) c.get("location");
                ATriggerPredicate.Item item = (ATriggerPredicate.Item) c.get("item");
                return CriterionTriggerInteractBlock.a.a(toNMS(location.getBlockPredicate() == null ? null : location.getBlockPredicate()), toNMS(item));
            }
            case "killed_by_crossbow": {
                ...
                return new CriterionTriggerKilledByCrossbow.a(predicates, toIntRange(uniqueTypes));
            }
            case "levitation": {
                Range distance = (Range) c.get("distance");
                Range duration = (Range) c.get("duration");
                return new CriterionTriggerLevitation.a(toNMSP(distance), toIntRange(duration));
            }
            case "location": new CriterionTriggerLocation.a(new MinecraftKey("location"), CriterionConditionLocation.a);
            case "nether_travel": {
                ATriggerPredicate.Location startPosition = (ATriggerPredicate.Location) c.get("start_position");
                Range distance = (Range) c.get("distance");
                return new CriterionTriggerNetherTravel.a(toNMSP(startPosition), CriterionConditionLocation.a, toNMSP(distance));
            }
            case "placed_block": {
                Material block = (Material) c.get("block");
                ATriggerPredicate.Item item = (ATriggerPredicate.Item) c.get("item");
                ...
                return new CriterionTriggerPlacedBlock.a(toNMS(block), toNMSP(state), toNMSP(location), toNMSP(item));
            }
            case "player_hurt_entity": {
                ATriggerPredicate.Damage damage = (ATriggerPredicate.Damage) c.get("damage");
                ATriggerPredicate.Entity entity = (ATriggerPredicate.Entity) c.get("entity");
                return new CriterionTriggerPlayerHurtEntity.a(toNMS(damage), toNMSP(entity));
            }
            case "recipe_unlocked": {
                NamespacedKey recipe = (NamespacedKey) c.get("recipe");
                return new CriterionTriggerRecipeUnlocked.a(toNMS(recipe));
            }
            case "shot_crossbow": {
                ATriggerPredicate.Item item = (ATriggerPredicate.Item) c.get("item");
                return new CriterionTriggerShotCrossbow.a(toNMSP(item));
            }
            case "slept_in_bed": CriterionTriggerLocation.a.c();
            case "slide_down_block": {
                Material block = (Material) c.get("block");
                BlockState state = (BlockState) c.get("state");
                return new CriterionSlideDownBlock.a(toNMS(block), toNMSP(state));
            }
            case "tame_animal": {
                ATriggerPredicate.Entity entity = (ATriggerPredicate.Entity) c.get("entity");
                return CriterionTriggerTamedAnimal.a.a(toNMSP(entity));
            }
            case "tick": new CriterionTriggerTick.a();
            case "used_ender_eye": {
                Range distance = (Range) c.get("distance");
                return new CriterionTriggerUsedEnderEye.a(toFloatRange(distance));
            }
            case "used_totem": {
                ATriggerPredicate.Item item = (ATriggerPredicate.Item) c.get("item");
                return new CriterionTriggerUsedTotem.a(toNMSP(item));
            }
            case "villager_trade": {
                ATriggerPredicate.Item item = (ATriggerPredicate.Item) c.get("item");
                ATriggerPredicate.Entity villager = (ATriggerPredicate.Entity) c.get("villager");
                return new CriterionTriggerVillagerTrade.a(toNMSP(villager), toNMSP(item));
            }
            case "voluntary_exile": return new CriterionTriggerLocation.a(new MinecraftKey("voluntary_exile"), CriterionConditionLocation.a);
    ...
    public static net.minecraft.server.v1_15_R1.Advancement toNMS(Advancement a) {
        ...
        net.minecraft.server.v1_15_R1.Advancement parent = a.getParent() == null ? null : toNMS(a.getParent());

        return new net.minecraft.server.v1_15_R1.Advancement(
                toNMS(a.getKey()),
                parent,
                nmsDisplay,
                toNMS(a.getReward()),
    ...
    public static ItemStack fromNMS(net.minecraft.server.v1_15_R1.ItemStack item) {
        if (item == null) return null;
    ...
    public static ItemStack fromNMS(Item item) {
        if (item == null) return null;
        return CraftItemStack.asBukkitCopy(new net.minecraft.server.v1_15_R1.ItemStack(item));
    }

    public static Enchantment fromNMS(net.minecraft.server.v1_15_R1.Enchantment enchant) {
    ...
    public static BlockState fromNMS(Block block, CriterionTriggerProperties predicate) {
        ...
        try {
            Class<?> propertyMatcherC = Class.forName("net.minecraft.server.v1_15_R1.CriterionTriggerProperties$c");
            ...
            for (IBlockState<?> property : block.getStates().d()) {
                if (!propertyMap.containsKey(property.a())) continue;

                String valueS = propertyMap.get(property.a());
    ...
    public static ATriggerPredicate.Enchantment fromNMS(CriterionConditionEnchantments p) {
        ...
        return ATriggerPredicate.Enchantment.builder()
                .enchantment(fromNMS(getObject(p, "c", net.minecraft.server.v1_15_R1.Enchantment.class)))
    ...
    public static AReward fromNMS(AdvancementRewards rewards) {
        ...
        try {
            ...
            return new AReward(
                    experience,
                    Arrays.stream(loot).map(Wrapper1_15_R1::fromNMS).collect(Collectors.toList()),
                    Arrays.stream(recipes).map(Wrapper1_15_R1::fromNMS).collect(Collectors.toList())
            );
        } catch (ReflectiveOperationException e) {
            throw new RuntimeException(e);
        }
    ...
    public static Advancement fromNMS(net.minecraft.server.v1_15_R1.Advancement a) {
        if (a == null) return null;
        NMSDisplay1_15_R1 display = new NMSDisplay1_15_R1(a.c());
    ...
    public void register(Advancement a) {
        ...
        net.minecraft.server.v1_15_R1.Advancement nms = toNMS(a);
    ...
    public Advancement getAdvancement(NamespacedKey key) {
        net.minecraft.server.v1_15_R1.Advancement nms = manager.REGISTRY.a(toNMS(key));
    ...
    public void addAdvancement(Player p, Set<Advancement> advancements) {
        ...
        Set<net.minecraft.server.v1_15_R1.Advancement> added = new HashSet<>();
        ...
        for (Advancement a : advancements) {
            ...
            try {
                Method regListeners = AdvancementDataPlayer.class.getDeclaredMethod("c", net.minecraft.server.v1_15_R1.Advancement.class);
    ...
    public void removeAdvancement(Player p, Set<NamespacedKey> key) {
        EntityPlayer sp = toNMS(p);
        Set<MinecraftKey> removed = key.stream().map(Wrapper1_15_R1::toNMS).collect(Collectors.toSet());
    ...
    public AProgress getProgress(Player p, NamespacedKey key) {
        ...
        return new AProgress1_15_R1(p, nms, sp.getAdvancementData().getProgress(nms));
    }
    ...
    public Advancement getSelectedTab(Player p) {
        ...
        net.minecraft.server.v1_15_R1.Advancement lastSelectedTab = getObject(sp.getAdvancementData(), "l", net.minecraft.server.v1_15_R1.Advancement.class);
