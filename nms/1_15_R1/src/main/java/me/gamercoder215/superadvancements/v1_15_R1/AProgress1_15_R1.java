...
import static me.gamercoder215.superadvancements.v1_15_R1.Wrapper1_15_R1.toNMS;

@SuppressWarnings("unchecked")
final class AProgress1_15_R1 implements AProgress {

    private final Player p;
    private final EntityPlayer sp;
    private final AdvancementDataPlayer manager;

    private final net.minecraft.server.v1_15_R1.Advancement advancement;
    private final AdvancementProgress handle;

    AProgress1_15_R1(Player p, net.minecraft.server.v1_15_R1.Advancement advancement, AdvancementProgress handle) {
        this.p = p;
        this.sp = toNMS(p);
    ...
    public @NotNull Map<String, ACriteriaProgress> getCriteria() {
        try {
            ...
            return criteria.entrySet()
                    .stream().collect(Collectors.toMap(Map.Entry::getKey, e -> new ACriteriaProgress1_15_R1(e.getValue())));
