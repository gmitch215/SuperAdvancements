...
public class TestWrapper1_20_R3 {

    @BeforeAll
    public static void setup() {
        SharedConstants.setVersion(new MockWorldVersion1_20_R3());
    ...
    @Test
    @DisplayName("Test Wrapper1_20_R3#getObject")
    public void testReflection() {
        Assertions.assertTrue(Wrapper1_20_R3.getBoolean(this, "b"));
        Assertions.assertEquals(Wrapper1_20_R3.getObject(this, "s", String.class), "test");
        Assertions.assertEquals(Wrapper1_20_R3.getInt(this, "i"), 3);
    }

    @Test
    @DisplayName("Test Wrapper1_20_R3#toNMS")
    public void testToNMS() {
        Assertions.assertNotNull(Wrapper1_20_R3.toNMS(NamespacedKey.minecraft("eee")));

        Assertions.assertNotNull(Wrapper1_20_R3.toNMS(light));
        Assertions.assertNotNull(Wrapper1_20_R3.toNMS(loc));
        Assertions.assertNotNull(Wrapper1_20_R3.toNMS(entity));
        Assertions.assertNotNull(Wrapper1_20_R3.toNMS(damage));

        Assertions.assertNotNull(Wrapper1_20_R3.toNMS(reward));
    }

    @Test
    @DisplayName("Test Wrapper1_20_R3#fromNMS")
    public void testFromNMS() {
        Assertions.assertNotNull(Wrapper1_20_R3.fromNMS(new ResourceLocation("eee")));
    }
