...
import net.minecraft.server.v1_16_R3.CriterionConditionEntity.b;
...
final class Wrapper1_16_R3 implements Wrapper {
    ...
    public static net.minecraft.server.v1_16_R3.ItemStack toNMS(ItemStack item) {
    ...
    public static net.minecraft.server.v1_16_R3.Enchantment toNMS(Enchantment enchantment) {
    ...
    public static CriterionTriggerProperties toNMSP(BlockState state) {
        ...
        try {
            Class<?> clazz = Class.forName("net.minecraft.server.v1_16_R3.CriterionTriggerProperties$a");
    ...
    public static CriterionConditionItem.a toNMS(ATriggerPredicate.Item predicate) {
        try {
            ...
            predicate.getEnchantments().stream().map(Wrapper1_16_R3::toNMS).forEach(builder::a);
    ...
    public static net.minecraft.server.v1_16_R3.Advancement toNMS(Advancement a) {
        ...
        net.minecraft.server.v1_16_R3.Advancement parent = a.getParent() == null ? null : toNMS(a.getParent());
    ...
    public static ItemStack fromNMS(net.minecraft.server.v1_16_R3.ItemStack item) {
        if (item == null) return null;
    ...
    public static World fromNMSW(ResourceKey<net.minecraft.server.v1_16_R3.World> world) {
        if (world == null) return null;
        RegistryMaterials<net.minecraft.server.v1_16_R3.World> registry = getRegistry(IRegistry.L);
    ...
    public static ItemStack fromNMS(Item item) {
        if (item == null) return null;
        return CraftItemStack.asBukkitCopy(new net.minecraft.server.v1_16_R3.ItemStack(item));
    }

    public static Enchantment fromNMS(net.minecraft.server.v1_16_R3.Enchantment enchant) {
    ...
    public static BlockState fromNMS(Block block, CriterionTriggerProperties predicate) {
        ...
        try {
            Class<?> propertyMatcherC = Class.forName("net.minecraft.server.v1_16_R3.CriterionTriggerProperties$c");
    ...
    public static ATriggerPredicate.Enchantment fromNMS(CriterionConditionEnchantments p) {
        ...
        return ATriggerPredicate.Enchantment.builder()
                .enchantment(fromNMS(getObject(p, "c", net.minecraft.server.v1_16_R3.Enchantment.class)))
    ...
    public static AReward fromNMS(AdvancementRewards rewards) {
        ...
        try {
            ...
            return new AReward(
                    experience,
                    Arrays.stream(loot).map(Wrapper1_16_R3::fromNMS).collect(Collectors.toList()),
                    Arrays.stream(recipes).map(Wrapper1_16_R3::fromNMS).collect(Collectors.toList())
            );
        } catch (ReflectiveOperationException e) {
            throw new RuntimeException(e);
        }
    ...
    public static Advancement fromNMS(net.minecraft.server.v1_16_R3.Advancement a) {
        if (a == null) return null;
        NMSDisplay1_16_R3 display = new NMSDisplay1_16_R3(a.c());
    ...
    public void register(Advancement a) {
        ...
        net.minecraft.server.v1_16_R3.Advancement nms = toNMS(a);
    ...
    public Advancement getAdvancement(NamespacedKey key) {
        net.minecraft.server.v1_16_R3.Advancement nms = manager.REGISTRY.a(toNMS(key));
    ...
    public void addAdvancement(Player p, Set<Advancement> advancements) {
        ...
        Set<net.minecraft.server.v1_16_R3.Advancement> added = new HashSet<>();
        ...
        for (Advancement a : advancements) {
            ...
            try {
                Method regListeners = AdvancementDataPlayer.class.getDeclaredMethod("c", net.minecraft.server.v1_16_R3.Advancement.class);
    ...
    public void removeAdvancement(Player p, Set<NamespacedKey> key) {
        EntityPlayer sp = toNMS(p);
        Set<MinecraftKey> removed = key.stream().map(Wrapper1_16_R3::toNMS).collect(Collectors.toSet());
    ...
    public AProgress getProgress(Player p, NamespacedKey key) {
        ...
        return new AProgress1_16_R3(p, nms, sp.getAdvancementData().getProgress(nms));
    }
    ...
    public Advancement getSelectedTab(Player p) {
        ...
        net.minecraft.server.v1_16_R3.Advancement lastSelectedTab = getObject(sp.getAdvancementData(), "l", net.minecraft.server.v1_16_R3.Advancement.class);
