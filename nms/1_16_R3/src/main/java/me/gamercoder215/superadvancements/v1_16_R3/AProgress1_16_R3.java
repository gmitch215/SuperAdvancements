...
import static me.gamercoder215.superadvancements.v1_16_R3.Wrapper1_16_R3.toNMS;

@SuppressWarnings("unchecked")
final class AProgress1_16_R3 implements AProgress {

    private final Player p;
    private final EntityPlayer sp;
    private final AdvancementDataPlayer manager;

    private final net.minecraft.server.v1_16_R3.Advancement advancement;
    private final AdvancementProgress handle;

    AProgress1_16_R3(Player p, net.minecraft.server.v1_16_R3.Advancement advancement, AdvancementProgress handle) {
        this.p = p;
        this.sp = toNMS(p);
    ...
    public @NotNull Map<String, ACriteriaProgress> getCriteria() {
        try {
            ...
            return criteria.entrySet()
                    .stream().collect(Collectors.toMap(Map.Entry::getKey, e -> new ACriteriaProgress1_16_R3(e.getValue())));
