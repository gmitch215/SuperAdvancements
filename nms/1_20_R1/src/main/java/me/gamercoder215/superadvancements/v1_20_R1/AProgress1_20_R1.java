...
import static me.gamercoder215.superadvancements.v1_20_R1.Wrapper1_20_R1.toNMS;

@SuppressWarnings("unchecked")
final class AProgress1_20_R1 implements AProgress {
    ...
    AProgress1_20_R1(Player p, net.minecraft.advancements.Advancement advancement, net.minecraft.advancements.AdvancementProgress handle) {
        this.p = p;
        this.sp = toNMS(p);
    ...
    public @NotNull Map<String, ACriteriaProgress> getCriteria() {
        try {
            ...
            return criteria.entrySet()
                    .stream().collect(Collectors.toMap(Map.Entry::getKey, e -> new ACriteriaProgress1_20_R1(e.getValue())));
