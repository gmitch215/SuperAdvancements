...
import org.bukkit.craftbukkit.v1_13_R2.potion.CraftPotionUtil;
...
final class Wrapper1_13_R2 implements Wrapper {
    ...
    public static net.minecraft.server.v1_13_R2.ItemStack toNMS(ItemStack item) {
    ...
    public static net.minecraft.server.v1_13_R2.Enchantment toNMS(Enchantment enchantment) {
    ...
    public static CriterionConditionLocation toNMS(ATriggerPredicate.Location predicate) {
        ...
        return new CriterionConditionLocation(
                ...
                predicate.getBiome() == null ? null : IRegistry.BIOME.get(new MinecraftKey(predicate.getBiome().name().toLowerCase())),
                "",
                predicate.getDimension() == null ? null : DimensionManager.a(new MinecraftKey(predicate.getDimension().getName()))
        );
    }
    ...
    public static net.minecraft.server.v1_13_R2.Advancement toNMS(Advancement a) {
        ...
        net.minecraft.server.v1_13_R2.Advancement parent = a.getParent() == null ? null : toNMS(a.getParent());

        return new net.minecraft.server.v1_13_R2.Advancement(
                toNMS(a.getKey()),
                parent,
                nmsDisplay,
                toNMS(a.getReward()),
    ...
    public static ItemStack fromNMS(net.minecraft.server.v1_13_R2.ItemStack item) {
        if (item == null) return null;
    ...
    public static ItemStack fromNMS(Item item) {
        if (item == null) return null;
        return CraftItemStack.asBukkitCopy(new net.minecraft.server.v1_13_R2.ItemStack(item));
    }

    public static Enchantment fromNMS(net.minecraft.server.v1_13_R2.Enchantment enchant) {
    ...
    public static ATriggerPredicate.Enchantment fromNMS(CriterionConditionEnchantments p) {
        ...
        return ATriggerPredicate.Enchantment.builder()
                .enchantment(fromNMS(getObject(p, "c", net.minecraft.server.v1_13_R2.Enchantment.class)))
    ...
    public static AReward fromNMS(AdvancementRewards rewards) {
        ...
        try {
            ...
            return new AReward(
                    experience,
                    Arrays.stream(loot).map(Wrapper1_13_R2::fromNMS).collect(Collectors.toList()),
                    Arrays.stream(recipes).map(Wrapper1_13_R2::fromNMS).collect(Collectors.toList())
            );
        } catch (ReflectiveOperationException e) {
            throw new RuntimeException(e);
        }
    ...
    public static Advancement fromNMS(net.minecraft.server.v1_13_R2.Advancement a) {
        if (a == null) return null;
        NMSDisplay1_13_R2 display = new NMSDisplay1_13_R2(a.c());
    ...
    public void register(Advancement a) {
        ...
        net.minecraft.server.v1_13_R2.Advancement nms = toNMS(a);
    ...
    public Advancement getAdvancement(NamespacedKey key) {
        net.minecraft.server.v1_13_R2.Advancement nms = manager.a(toNMS(key));
    ...
    public void addAdvancement(Player p, Set<Advancement> advancements) {
        ...
        Set<net.minecraft.server.v1_13_R2.Advancement> added = new HashSet<>();
        ...
        for (Advancement a : advancements) {
            ...
            try {
                Method regListeners = AdvancementDataPlayer.class.getDeclaredMethod("c", net.minecraft.server.v1_13_R2.Advancement.class);
    ...
    public void removeAdvancement(Player p, Set<NamespacedKey> key) {
        EntityPlayer sp = toNMS(p);
        Set<MinecraftKey> removed = key.stream().map(Wrapper1_13_R2::toNMS).collect(Collectors.toSet());
    ...
    public AProgress getProgress(Player p, NamespacedKey key) {
        ...
        return new AProgress1_13_R2(p, nms, sp.getAdvancementData().getProgress(nms));
    }
    ...
    public Advancement getSelectedTab(Player p) {
        ...
        net.minecraft.server.v1_13_R2.Advancement lastSelectedTab = getObject(sp.getAdvancementData(), "l", net.minecraft.server.v1_13_R2.Advancement.class);
