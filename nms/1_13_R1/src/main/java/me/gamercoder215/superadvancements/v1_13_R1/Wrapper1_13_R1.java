...
import org.bukkit.craftbukkit.v1_13_R1.potion.CraftPotionUtil;
...
final class Wrapper1_13_R1 implements Wrapper {
    ...
    public static CriterionConditionValue.d toIntRange(Range r) {
        if (r == null) return CriterionConditionValue.d.e;

        try {
            Constructor<CriterionConditionValue.d> intRangeC = CriterionConditionValue.d.class.getDeclaredConstructor(Integer.class, Integer.class);
    ...
    public static CriterionConditionValue.c toFloatRange(Range r) {
        if (r == null) return CriterionConditionValue.c.e;

        try {
            Constructor<CriterionConditionValue.c> floatRangeC = CriterionConditionValue.c.class.getDeclaredConstructor(Float.class, Float.class);
    ...
    public static Range fromNMS(CriterionConditionValue.c r) {
        if (r == null) return Range.ANY;
        return new Range(r.a(), r.b());
    }

    public static Range fromNMS(CriterionConditionValue.d r) {
        if (r == null) return Range.ANY;
        return new Range(r.a(), r.b());
    }
    ...
    public static net.minecraft.server.v1_13_R1.ItemStack toNMS(ItemStack item) {
    ...
    public static net.minecraft.server.v1_13_R1.Enchantment toNMS(Enchantment enchantment) {
    ...
    public static EntityTypes<?> toNMS(EntityType type) {
        if (type == null) return null;
        MinecraftKey loc = toNMS(NamespacedKey.minecraft(type.getName()));
        return EntityTypes.REGISTRY.get(loc);
    }
    ...
    public static CriterionConditionLocation toNMS(ATriggerPredicate.Location predicate) {
        ...
        return new CriterionConditionLocation(
                toFloatRange(predicate.getXRange()),
                toFloatRange(predicate.getYRange()),
                toFloatRange(predicate.getZRange()),
    ...
    public static CriterionConditionItem.a toNMS(ATriggerPredicate.Item predicate) {
        try {
            ...
            setObject(builder, "a", predicate.getEnchantments()
                    .stream()
                    .map(Wrapper1_13_R1::toNMS)
    ...
    public static CriterionConditionEntity.a toNMS(ATriggerPredicate.Entity predicate) {
        try {
            ...
            if (predicate.getType() != null) builder.a(new CriterionConditionEntityType(toNMS(predicate.getType())));
    ...
    public static CriterionConditionDamage toNMS(ATriggerPredicate.Damage predicate) {
        ...
        CriterionConditionValue.c dealt = toFloatRange(predicate.getDealtRange());
        CriterionConditionValue.c taken = toFloatRange(predicate.getTakenRange());
        CriterionConditionEntity source = toNMSP(predicate.getSourcePredicate());
    ...
    public static CriterionInstance toNMS(ATrigger trigger) {
        ...
        switch (trigger.getKey().getKey()) {
            ...
            case "placed_block": {
                ...
                return new CriterionTriggerPlacedBlock.b(toNMS(block), toNMS(state), toNMS(location), toNMSP(item));
            }
            ...
            case "tame_animal": {
                ATriggerPredicate.Entity entity = (ATriggerPredicate.Entity) c.get("entity");
                return new CriterionTriggerTamedAnimal.b(toNMSP(entity));
            }
    ...
    public static ATrigger fromNMS(CriterionInstance t) {
        ...
        switch (t.a().getKey()) {
            ...
            case "bee_nest_destroyed": return ATrigger.beeNestDestroyed(
                ...
                fromNMS(getObject(t, "b", CriterionConditionItem.class)),
                fromNMS(getObject(t, "c", CriterionConditionValue.d.class))
            );
            ...
            case "channeled_lightning": return ATrigger.channeledLightning(
                Arrays.stream(getObject(t, "a", CriterionConditionEntity[].class))
                        .map(Wrapper1_13_R1::fromNMS)
                        .collect(Collectors.toSet())
            );
            case "construct_beacon": return ATrigger.constructBeacon(
                fromNMS(getObject(t, "a", CriterionConditionValue.d.class))
            );
            ...
            case "enchanted_item": return ATrigger.enchantedItem(
                fromNMS(getObject(t, "a", CriterionConditionItem.class)),
                fromNMS(getObject(t, "b", CriterionConditionValue.d.class))
            );
            case "enter_block": return ATrigger.enterBlock(
                fromNMS(getObject(t, "a", Block.class)),
                fromNMSB(getObject(t, "a", Block.class))
            );
            ...
            case "used_ender_eye": return ATrigger.usedEnderEye(
                fromNMS(getObject(t, "a", CriterionConditionValue.c.class))
            );
    ...
    public static net.minecraft.server.v1_13_R1.Advancement toNMS(Advancement a) {
        ...
        net.minecraft.server.v1_13_R1.Advancement parent = a.getParent() == null ? null : toNMS(a.getParent());

        return new net.minecraft.server.v1_13_R1.Advancement(
                toNMS(a.getKey()),
                parent,
                nmsDisplay,
                toNMS(a.getReward()),
    ...
    public static ItemStack fromNMS(net.minecraft.server.v1_13_R1.ItemStack item) {
        if (item == null) return null;
    ...
    public static EntityType fromNMS(CriterionConditionEntityType p) {
        ...
        try {
            ...
            if (EntityTypes.class.isAssignableFrom(typeC)) {
                ...
                return EntityType.valueOf(EntityTypes.getName(entityType).getKey().toUpperCase());
            } else {
    ...
    public static Range fromNMS(CriterionConditionDistance p) {
        if (p == null) return null;
        return fromNMS(getObject(p, "f", CriterionConditionValue.c.class));
    }

    public static ItemStack fromNMS(Item item) {
        if (item == null) return null;
        return CraftItemStack.asBukkitCopy(new net.minecraft.server.v1_13_R1.ItemStack(item));
    }

    public static Enchantment fromNMS(net.minecraft.server.v1_13_R1.Enchantment enchant) {
        if (enchant == null) return null;
        NamespacedKey key = fromNMS(net.minecraft.server.v1_13_R1.Enchantment.getId((enchant)));
    ...
    public static BlockState fromNMSB(final Block block) {
        CraftBlockState state = new CraftBlockState(fromNMS(block));
        state.setData(block.getBlockData());
        return state;
    }
    ...
    public static ATriggerPredicate.Damage fromNMS(CriterionConditionDamage p) {
        ...
        return ATriggerPredicate.Damage.builder()
                .dealt(fromNMS(getObject(p, "b", CriterionConditionValue.c.class)))
                .taken(fromNMS(getObject(p, "c", CriterionConditionValue.c.class)))
    ...
    public static ATriggerPredicate.Enchantment fromNMS(CriterionConditionEnchantments p) {
        ...
        return ATriggerPredicate.Enchantment.builder()
                .enchantment(fromNMS(getObject(p, "c", net.minecraft.server.v1_13_R1.Enchantment.class)))
                .level(fromNMS(getObject(p, "d", CriterionConditionValue.d.class)))
                .build();
    }
    ...
    public static ATriggerPredicate.Item fromNMS(CriterionConditionItem p) {
        ...
        ATriggerPredicate.Item.Builder builder = ATriggerPredicate.Item.builder()
                ...
                .count(fromNMS(getObject(p, "d", CriterionConditionValue.d.class)))
                .durability(fromNMS(getObject(p, "e", CriterionConditionValue.d.class)));
    ...
    public static ATriggerPredicate.Location fromNMS(CriterionConditionLocation p) {
        ...
        return ATriggerPredicate.Location.builder()
                .x(fromNMS(getObject(p, "b", CriterionConditionValue.c.class)))
                .y(fromNMS(getObject(p, "c", CriterionConditionValue.c.class)))
                .z(fromNMS(getObject(p, "d", CriterionConditionValue.c.class)))
    ...
    public static AReward fromNMS(AdvancementRewards rewards) {
        ...
        try {
            ...
            return new AReward(
                    experience,
                    Arrays.stream(loot).map(Wrapper1_13_R1::fromNMS).collect(Collectors.toList()),
                    Arrays.stream(recipes).map(Wrapper1_13_R1::fromNMS).collect(Collectors.toList())
            );
        } catch (ReflectiveOperationException e) {
            throw new RuntimeException(e);
        }
    ...
    public static Advancement fromNMS(net.minecraft.server.v1_13_R1.Advancement a) {
        if (a == null) return null;
        NMSDisplay1_13_R1 display = new NMSDisplay1_13_R1(a.c());
    ...
    public void register(Advancement a) {
        ...
        net.minecraft.server.v1_13_R1.Advancement nms = toNMS(a);
    ...
    public Advancement getAdvancement(NamespacedKey key) {
        net.minecraft.server.v1_13_R1.Advancement nms = manager.a(toNMS(key));
    ...
    public void addAdvancement(Player p, Set<Advancement> advancements) {
        ...
        Set<net.minecraft.server.v1_13_R1.Advancement> added = new HashSet<>();
        ...
        for (Advancement a : advancements) {
            ...
            try {
                Method regListeners = AdvancementDataPlayer.class.getDeclaredMethod("c", net.minecraft.server.v1_13_R1.Advancement.class);
    ...
    public void removeAdvancement(Player p, Set<NamespacedKey> key) {
        EntityPlayer sp = toNMS(p);
        Set<MinecraftKey> removed = key.stream().map(Wrapper1_13_R1::toNMS).collect(Collectors.toSet());
    ...
    public AProgress getProgress(Player p, NamespacedKey key) {
        ...
        return new AProgress1_13_R1(p, nms, sp.getAdvancementData().getProgress(nms));
    }
    ...
    public Advancement getSelectedTab(Player p) {
        ...
        net.minecraft.server.v1_13_R1.Advancement lastSelectedTab = getObject(sp.getAdvancementData(), "l", net.minecraft.server.v1_13_R1.Advancement.class);
