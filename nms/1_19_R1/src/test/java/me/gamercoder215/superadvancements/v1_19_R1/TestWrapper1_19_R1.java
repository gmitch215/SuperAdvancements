...
public class TestWrapper1_19_R1 {

    @BeforeAll
    public static void setup() {
        SharedConstants.setVersion(new MockWorldVersion1_19_R1());
    ...
    @Test
    @DisplayName("Test Wrapper1_19_R1#getObject")
    public void testReflection() {
        Assertions.assertTrue(Wrapper1_19_R1.getBoolean(this, "b"));
        Assertions.assertEquals(Wrapper1_19_R1.getObject(this, "s", String.class), "test");
        Assertions.assertEquals(Wrapper1_19_R1.getInt(this, "i"), 3);
    }

    @Test
    @DisplayName("Test Wrapper1_19_R1#toNMS")
    public void testToNMS() {
        Assertions.assertNotNull(Wrapper1_19_R1.toNMS(NamespacedKey.minecraft("eee")));

        Assertions.assertNotNull(Wrapper1_19_R1.toNMS(light));
        Assertions.assertNotNull(Wrapper1_19_R1.toNMS(loc));
        Assertions.assertNotNull(Wrapper1_19_R1.toNMS(entity));
        Assertions.assertNotNull(Wrapper1_19_R1.toNMS(damage));

        Assertions.assertNotNull(Wrapper1_19_R1.toNMS(reward));
    }

    @Test
    @DisplayName("Test Wrapper1_19_R1#fromNMS")
    public void testFromNMS() {
        Assertions.assertNotNull(Wrapper1_19_R1.fromNMS(new ResourceLocation("eee")));
    }
