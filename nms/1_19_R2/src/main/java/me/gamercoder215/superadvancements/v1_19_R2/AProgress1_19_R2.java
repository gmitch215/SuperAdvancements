...
import static me.gamercoder215.superadvancements.v1_19_R2.Wrapper1_19_R2.toNMS;

@SuppressWarnings("unchecked")
final class AProgress1_19_R2 implements AProgress {
    ...
    AProgress1_19_R2(Player p, net.minecraft.advancements.Advancement advancement, AdvancementProgress handle) {
        this.p = p;
        this.sp = toNMS(p);
    ...
    public @NotNull Map<String, ACriteriaProgress> getCriteria() {
        try {
            ...
            return criteria.entrySet()
                    .stream().collect(Collectors.toMap(Map.Entry::getKey, e -> new ACriteriaProgress1_19_R2(e.getValue())));
