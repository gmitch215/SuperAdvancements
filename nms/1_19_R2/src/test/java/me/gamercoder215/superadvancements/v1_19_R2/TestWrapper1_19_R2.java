...
public class TestWrapper1_19_R2 {

    @BeforeAll
    public static void setup() {
        SharedConstants.setVersion(new MockWorldVersion1_19_R2());
    ...
    @Test
    @DisplayName("Test Wrapper1_19_R2#getObject")
    public void testReflection() {
        Assertions.assertTrue(Wrapper1_19_R2.getBoolean(this, "b"));
        Assertions.assertEquals(Wrapper1_19_R2.getObject(this, "s", String.class), "test");
        Assertions.assertEquals(Wrapper1_19_R2.getInt(this, "i"), 3);
    }

    @Test
    @DisplayName("Test Wrapper1_19_R2#toNMS")
    public void testToNMS() {
        Assertions.assertNotNull(Wrapper1_19_R2.toNMS(NamespacedKey.minecraft("eee")));

        Assertions.assertNotNull(Wrapper1_19_R2.toNMS(light));
        Assertions.assertNotNull(Wrapper1_19_R2.toNMS(loc));
        Assertions.assertNotNull(Wrapper1_19_R2.toNMS(entity));
        Assertions.assertNotNull(Wrapper1_19_R2.toNMS(damage));

        Assertions.assertNotNull(Wrapper1_19_R2.toNMS(reward));
    }

    @Test
    @DisplayName("Test Wrapper1_19_R2#fromNMS")
    public void testFromNMS() {
        Assertions.assertNotNull(Wrapper1_19_R2.fromNMS(new ResourceLocation("eee")));
    }
